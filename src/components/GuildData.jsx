					...
					<CardContent>
						<div className={classes.guildInfo}>
							<div className={classes.guildMetaInformation}>
								...
								<Typography variant="h4">
									Server:{" "}
									{selectedMetaInformation.FreeCompany.Server}
								</Typography>
								<Typography variant="h4">
									Rank:{" "}
									{selectedMetaInformation.FreeCompany.Rank}
								</Typography>
							</div>
						...
						<Typography
							variant="h4"
							className={classes.focusStyling}
						>
							Focus
						</Typography>
						<Paper
				...
				<Card className={`${classes.root}`}>
					<CardContent>
						<Typography
							...
							align="center"
						>
							{selectedMetaInformation.Character.Name} Appears to
							not be in a guild...
						</Typography>
					</CardContent>
				</Card>
