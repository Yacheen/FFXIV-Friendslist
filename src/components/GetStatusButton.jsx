...
export default function GetStatusButton(props) {
    ...
    const fetchFFXIVApi = async () => {
            ...
            setIsLoading(true);
            const response = await fetch(`https://xivapi.com/character/${props.selectedIndex}?extended=1,data=FR`);
    ...
    return (
            ...
            <div className="status-button-container"   >
                ...
                <Button disabled={props.selectedButton} onClick={fetchFFXIVApi} size="large" variant="contained" color="secondary" className="status-button">
